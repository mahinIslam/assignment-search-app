        ...
        <Container fluid="xs">
            ...
            >
                ...
                <Col xs={12} md={12} lg={5} className="movieInfo p-4 animated fadeInRightBig">
                    ...
                    <h5 className="mb-4 text-warning">Release date: <span className="text-light">{editReleaseDate(movieInfo.release_date)}</span></h5>
                    ...
                    <div className="text-warning mt-3 h5">Type:
                    ...
                    loading ? <Spinner /> :
                        (
                            visible < actors.length ? <LoadMoreBtn
                                text={(actors.length - visible) + ' Actor/Actres Show More '}
